...
ItaniumVTableBuilder::ItaniumVTableBuilder(ItaniumVTableContext &VTables,
                       const CXXRecordDecl *MostDerivedClass,
                       CharUnits MostDerivedClassOffset,
...
//  you might want to see examples in test/CodeGenCXX/microsoft-abi-vtables-*.cpp
  ...
  void VFTableBuilder::AddThunk(const CXXMethodDecl *MD, const ThunkInfo &Thunk) {
  ...
  void VFTableBuilder::AddMethod(const CXXMethodDecl *MD, ThunkInfo TI) {
    if (!TI.isEmpty()) {
  ...
  void VFTableBuilder::LayoutVFTable() {
  ...
  VFTableBuilder::VFTableBuilder(MicrosoftVTableContext &VTables,
